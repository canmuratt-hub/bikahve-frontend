...
* **Framework:** [React](https://reactjs.org/) (Vite ile yapılandırıldı)
...
1. Depoyu klonlayın:
   ```bash
   git clone [https://github.com/canmuratt-hub/bikahve-frontend.git](https://github.com/canmuratt-hub/bikahve-frontend.git)

Klasöre gidin: cd bikahve-frontend
